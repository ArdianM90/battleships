...
public class MainMenuPanel extends JPanel {
    ...
    private void serverOnClickAction() {
        ...
        ServerHandler server = new ServerHandler(PORT, goToGameFunction, gameController::setOpponentShipsState, gameController::handleShot);
        server.start();
    ...
    private void clientOnClickAction() {
        // todo: przenieść logikę sieciową do kontrolera
        ClientHandler client = new ClientHandler(HOST, PORT, goToGameFunction, gameController::setOpponentShipsState, gameController::handleShot);
        client.start();
